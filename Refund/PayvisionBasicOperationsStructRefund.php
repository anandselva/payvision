<?php
/**
 * File for class PayvisionBasicOperationsStructRefund
 ...
 */
/**
 * This class stands for PayvisionBasicOperationsStructRefund originally named Refund
 ...
 * @date 2013-05-10
 */
class PayvisionBasicOperationsStructRefund extends PayvisionBasicOperationsWsdlClass
{
	/**
	 * The memberId
	 * Meta informations extracted from the WSDL
	 ...
	 * @return PayvisionBasicOperationsStructRefund
	 */
	...
	{
		parent::__construct(array('memberId'=>$_memberId,'transactionId'=>$_transactionId,'amount'=>$_amount,'currencyId'=>$_currencyId,'memberGuid'=>$_memberGuid,'transactionGuid'=>$_transactionGuid,'trackingMemberCode'=>$_trackingMemberCode));
	}
	/**
	 * Get memberId value
	 * @return int
