<?php
/**
 * File for class PayvisionBasicOperationsStructCardFundTransfer
 ...
 */
/**
 * This class stands for PayvisionBasicOperationsStructCardFundTransfer originally named CardFundTransfer
 ...
 * @date 2013-05-10
 */
class PayvisionBasicOperationsStructCardFundTransfer extends PayvisionBasicOperationsWsdlClass
{
	/**
	 * The memberId
	 * Meta informations extracted from the WSDL
	...
	public $avsZip;
	/**
	 * Constructor method for CardFundTransfer
	 ...
	 * @return PayvisionBasicOperationsStructCardFundTransfer
	 */
